              ...
              >
                ...
                <div className="flex flex-col items-center sm:items-start gap-1">
                  <div className="flex items-center gap-0.5">
                    ...
                    <span className="ml-1.5 text-xs font-semibold text-white/60">{t("cta_rating_value")}</span>
                  </div>
                  <p className="text-xs text-white/40 font-medium leading-snug">{t("cta_trusted_by")}</p>
                </div>
              </motion.div>
